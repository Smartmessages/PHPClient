 ...
 * @copyright 2012 Synchromedia Limited
...
class SmartmessagesAPI {
	 ...
	 * @access public
	 */
	public function sendmailshot($templateid, $listid, $title = '', $campaignid, $subject = '', $fromaddr, $fromname = '', $replyto = '', $when = 'now', $continuous = false, $elements = array()) {
		$res = $this->dorequest('sendmailshot', array(
